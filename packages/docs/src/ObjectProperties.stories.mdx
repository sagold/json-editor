...
- ❎ [**oneOf**](#oneof) - not on root object, oneOfProperty highly recommended
...
- additional type in _oneOf_ item is required
- 🐞 currently unsupported on root object
- _oneOfProperty_ is highly recommended
...
_oneOf_ statement on root level
