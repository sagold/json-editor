...
- invalid property error is not removed from object when property was fixed [@see additionalProperties](#additional-properties)
  ...
  <JsonForm
    ...
    schema={{
      ...
      then: {
        ...
        properties: {
          else: { title: 'Else statement', type: 'boolean' },
