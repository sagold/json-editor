...
import { isParentNode, JsonNode, isJsonError, Change } from '../types';
...
export function removeNode<T extends JsonNode = JsonNode>(previousRoot: T, pointer: JsonPointer): [JsonError] | [T, Change[]] {
